...
#include "MC3dExplorerLib_ErrorCode.h"
	...
	public:
			...
			: m_ErrorCode(ErrorCode::NONE)
		{
			...
			if (!success)
			{
				...
				m_ErrorCode = ErrorCode::ERROR_VERTEX_SHADER_COMPILATION_FAILED;
				throw m_ErrorCode;
			}
			...
			if (!success)
			{
				...
				m_InfoLog = ssInfoLog.str();
				m_ErrorCode = ErrorCode::ERROR_FRAGMENT_SHADER_COMPILATION_FAILED;
				throw m_ErrorCode;
			}
			...
			if (!success)
			{
				...
				m_InfoLog = ssInfoLog.str();
				m_ErrorCode = ErrorCode::ERROR_SHADER_PROGRAM_LINKING_FAILED;
				throw m_ErrorCode;
			}
		...
		auto GetInfo() const -> std::pair<ErrorCode, std::string>
		{
