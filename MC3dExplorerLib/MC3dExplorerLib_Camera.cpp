...
auto MC3dExplorerLib::Camera::DoArcballRotation(float angleX, float angleY) -> void
{
...
auto MC3dExplorerLib::Camera::UpdateViewMatrix() -> void
{
	m_View = glm::lookAt(m_Eye, m_Center, m_Up);
}


auto MC3dExplorerLib::Camera::SetViewIsometric() -> void
{
...
auto MC3dExplorerLib::Camera::SetViewBack() -> void
{
	m_Right = -1.f * axisX;
	m_Up = axisZ;
	m_Eye = axisY;
...
auto MC3dExplorerLib::Camera::SetViewBottom() -> void
{
	m_Right = -1.f * axisX;
	m_Up = axisY;
	m_Eye = -1.f * axisZ;
...
auto MC3dExplorerLib::Camera::SetViewFront() -> void
{
	m_Right = axisX;
	m_Up = axisZ;
	m_Eye = -1.f * axisY;
...
auto MC3dExplorerLib::Camera::SetViewLeft() -> void
{
	m_Right = -1.f * axisY;
	m_Up = axisZ;
	m_Eye = -1.f * axisX;
...
auto MC3dExplorerLib::Camera::SetViewRight() -> void
{
	m_Right = axisY;
	m_Up = axisZ;
	m_Eye = axisX;
...
auto MC3dExplorerLib::Camera::SetViewTop() -> void
{
	m_Right = axisX;
	m_Up = axisY;
	m_Eye = axisZ;
...
auto MC3dExplorerLib::Camera::ViewMatrix() const -> glm::mat4
{
	return m_View;
}
